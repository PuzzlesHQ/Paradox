...
public class ParadoxPlayer implements IParadoxPlayer {

    Player player;


    IParadoxPlayerEntity entity;
    Vector3 lastSafePosition;
    long lastBreakTime = 0;
    IParadoxAccount account;
    public ParadoxPlayer(Player player, PlayerEntity playerEntity){
        this.player = player;
        this.entity = (IParadoxPlayerEntity) playerEntity.getParadoxEntity();
...
//    }
     ...
     */
    public IParadoxPlayerEntity getEntity(){
        return entity;
    }
     ...
     * @see IParadoxAccount
     */
    public IParadoxAccount getAccount(){
        return account;
    }
