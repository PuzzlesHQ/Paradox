...
public class ParadoxEntity implements IParadoxEntity {
    ...
    static Map<Class<? extends IParadoxEntity>,String> classtoidentity = new HashMap<>();
    public static final ObjectMap<UUID, IParadoxEntity> uuidToParadoxEntity = new ObjectMap<>();
     ...
     * @see ParadoxEntity
     */
    public static String getEntityIDByClass(@NotNull Class<? extends IParadoxEntity> e){
     ...
     * @see ParadoxEntity
     */
    public static<E extends ParadoxEntity> E spawnEntity(@NotNull Class<E> eClass,@NotNull Vector3 position,@NotNull IParadoxZone zone){
    ...
    static ParadoxEntity getByUUID(@NotNull UUID uuid){
        return (ParadoxEntity) uuidToParadoxEntity.get(uuid);
    }
    static {
